...
import { Card } from './UI';
import { Truck, AlertCircle, CheckCircle2, Clock, Plus, Filter, Download, X, AlertTriangle, Wrench, MapPin, ArrowRight, Info, Edit2 } from 'lucide-react';
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex items-center gap-2">
                  <button 
                    ...
                    className="p-1.5 rounded bg-elegant-bg border border-elegant-border text-elegant-dim hover:text-elegant-accent hover:border-elegant-accent/50 hover:bg-elegant-accent/5 transition-all shadow-sm"
                    title="Editar Veículo / Mudar Status"
                  >
                    <Edit2 size={12} />
                  </button>
                  <span className={cn(
            ...
            >
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[11px] font-bold text-elegant-dim uppercase">Possui Seguro?</label>
                    <div className="flex items-center h-full pt-2">
                       <input 
                         name="hasInsurance" 
                         type="checkbox" 
                         defaultChecked={selectedVehicle.hasInsurance}
                         className="w-4 h-4 rounded border-elegant-border bg-elegant-bg text-elegant-accent focus:ring-elegant-accent/30"
                       />
                       <span className="ml-2 text-xs text-elegant-text">Sim, veículo segurado</span>
                    </div>
                  </div>
                </div>

                <div className="space-y-1.5">
                  <label className="text-[11px] font-bold text-elegant-dim uppercase opacity-50">Vencimento do Seguro</label>
                  <input name="insuranceExpiry" type="date" defaultValue={selectedVehicle.insuranceExpiry} className="w-full bg-elegant-bg border border-elegant-border rounded px-3 py-2 text-sm text-elegant-text focus:outline-none focus:border-elegant-accent disabled:opacity-30" />
                </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
              ...
              <form 
                onSubmit={(e) => {
                  ...
                  const newVehicle: Vehicle = {
                    ...
                    costPerKm: Number(formData.get('costPerKm')),
                    nextMaintenanceKm: Number(formData.get('nextMaintenanceKm')),
                    insuranceExpiry: (formData.get('insuranceExpiry') as string) || new Date().toISOString().split('T')[0],
                    hasInsurance: formData.get('hasInsurance') === 'on',
                  };
              ...
              >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center h-full pt-2">
                       <input 
                         ...
                         className="w-4 h-4 rounded border-elegant-border bg-elegant-bg text-elegant-accent focus:ring-elegant-accent/30"
                       />
                       <span className="ml-2 text-xs text-elegant-text">Sim, segurado</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  <label className="text-[11px] font-bold text-elegant-dim uppercase opacity-50">Vencimento do Seguro</label>
                  <input name="insuranceExpiry" type="date" className="w-full bg-elegant-bg border border-elegant-border rounded px-3 py-2 text-sm text-elegant-text focus:outline-none focus:border-elegant-accent" />
                </div>

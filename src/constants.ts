...
export const MOCK_VEHICLES: Vehicle[] = [
  { id: '1', plate: 'ABC-1234', model: 'Volvo FH 540', year: 2022, status: 'active', currentKm: 125000, costPerKm: 2.45, nextMaintenanceKm: 130000, insuranceExpiry: '2026-12-15' },
  { id: '2', plate: 'XYZ-5678', model: 'Scania R 450', year: 2021, status: 'maintenance', currentKm: 210000, costPerKm: 2.60, nextMaintenanceKm: 210000, insuranceExpiry: '2026-08-20' },
  { id: '3', plate: 'KJH-9012', model: 'Mercedes-Benz Actros', year: 2023, status: 'active', currentKm: 45000, costPerKm: 2.30, nextMaintenanceKm: 50000, insuranceExpiry: '2027-01-10' },
  { id: '4', plate: 'LMN-3456', model: 'DAF XF 530', year: 2020, status: 'alert', currentKm: 350000, costPerKm: 2.85, nextMaintenanceKm: 355000, insuranceExpiry: '2026-04-30' },
];
